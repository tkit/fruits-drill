/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b94f1d7e500c15a163b0f1bd3f3d4b22)
// Runtime types generated with workerd@1.20260415.1 2026-04-18 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    DRILL_FILES: R2Bucket;
    DB: D1Database;
    ASSETS: Fetcher;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "NEXT_PUBLIC_BASE_URL" | "REVALIDATE_TOKEN" | "ADMIN_API_TOKEN">
  > {}
}
